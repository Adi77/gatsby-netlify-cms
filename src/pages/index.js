...
export const HomePageTemplate = ({ allSections, home, upcomingMeetup = null }) => {
 ...
 {allSections && (
                <div style={{ color: `white` }}>
                  {allSections.map((allSection, index) => (
                      ...
                      <span key={index}>
                        {allSection.node.frontmatter.title}
                      </span>
...
class HomePage extends React.Component {
  render() {
    ...
    const allSections = data.aboutPageData.edges;
    ...
    return (
      <Layout footerData={footerData} navbarData={navbarData}>
        ...
        <HomePageTemplate allSections={allSections} home={home} upcomingMeetup={upcomingMeetup} />
      </Layout>
    );
  }
}
